...
<head>
    ...
    <title>Landloard Notification</title>
    <style>
        body{
            margin: 0;
            padding: 0 0;
...
<body>
    ...
    $sql = "SELECT p.property_name, l.fullname, s.student_name, r.reservation_status
            FROM reservations r 
            ...
            WHERE r.reservation_status = 'Approved' OR r.reservation_status = 'Cancelled'";
