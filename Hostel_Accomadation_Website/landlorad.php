...
<body>
    ...
    $stmt->bind_param("s", $email); // Bind the email instead of landlordId
    $stmt->execute();
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<h1>Your All Accommodations</h1>';
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<p style="font-size:14px;font-style: italic;">' . $row['status'] . '</p>'; // Assuming 'status' column contains property status (e.g., Pending)
            echo '</div>';
            echo '</div>';
        }
        ...
        // Output a message if there are no properties
    ...
    <section class="feature-products">
        ...
        <div class="allfpimgs">
            ...
            <div class="fpimgs">
                <img src="https://image-tc.galaxy.tf/wijpeg-bxdv8c6ji6oftcroue33x7hfl/double-duble_standard.jpg?crop=122%2C0%2C1757%2C1318" alt="">
                <div class="roominfo">
                    <h3>The palace</h3>
                    <p class="roomPrice"><span style="color:#088178; font-weight: 700;">$78</span></p>
                    <p>Number of bed 2</p>
            ...
            <div class="fpimgs">
                <img src="https://image-tc.galaxy.tf/wijpeg-f3rv61ktim9s1nyp84ovvfdbw/triple-3_standard.jpg?crop=114%2C0%2C1773%2C1330" alt="">
                <div class="roominfo">
                    <h3>The palace</h3>
                    <p class="roomPrice"><span style="color:#088178; font-weight: 700;">$78</span></p>
                    <p>Number of bed 2</p>
